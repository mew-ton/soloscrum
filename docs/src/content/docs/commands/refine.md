...
3. **Size gate.** If the size-check SP exceeds 5, `/refine` flags the Issue as oversized and suggests splitting before creating it. See [issue size](/policies/issue-size/).
